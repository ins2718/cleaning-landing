...
function LeftSide() {
    ...
    return <div className="pr-0 min-[1170px]:pr-[117px] mx-auto my-0 text-center lg:text-left w-[830px] relative z-[4]">
        ...
        <p className="text-[16px] md:text-[24px] leading-[24px] md:leading-[47px] font-semibold text-left font-secondary">
            <strong className="">¿Tus sillones de chenille necesitan una limpieza profunda?</strong>
            <br />
            ...
            <br />¡Eliminamos manchas, olores, bacterias y ácaros en sillones de chenille, devolviéndoles su frescura original!
            <br />
            </p>
