...
function LeftSide() {
    ...
    return <div className="pr-0 min-[1170px]:pr-[117px] mx-auto my-0 text-center lg:text-left w-[830px] relative z-[4]">
        ...
        <p className="text-[16px] md:text-[24px] leading-[24px] md:leading-[47px] font-semibold text-left font-secondary">
            ...
            <br />
            Con más de 10 años de experiencia, en limpiarmuebles.pro ofrecemos servicios profesionales de sanitización y desinfección de colchones a domicilio, enfocados en la eliminación de ácaros, bacterias y alérgenos.<br />Utilizamos productos y equipos de limpieza profesionales para desinfectar colchones y asegurar un ambiente más limpio y saludable para descansar.
        </p>
