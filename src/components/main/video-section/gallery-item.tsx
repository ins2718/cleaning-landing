...
function GalleryItem({ url, index }: GalleryItemProps) {
    ...
    return <div style={{ backgroundImage: `url(${url})` }} className="my-[10px] mx-auto min-[720px]:mx-[10px] w-[calc(83.4%-10px)] min-[720px]:w-[calc(50%-20px)] relative h-[363px] bg-cover bg-center cursor-pointer break-words">
        <a
            href="#"
            onClick={(e) => {
                e.preventDefault();
