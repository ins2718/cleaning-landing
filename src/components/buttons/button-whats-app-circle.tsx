...
function ButtonWhatsAppCircle() {
    return <div className="fixed top-[100px] sm:top-[unset] sm:bottom-10 right-10 z-50">
        ...
        <button onClick={() => window.location.href = WhatsAppService.getLink()} className="size-[60px] rounded-full flex items-center justify-center bg-[--whats-app-color] text-white animate-whatsAppButtonScale shadow-[0_0_20px_0_rgba(0,0,0,0.3)]">
