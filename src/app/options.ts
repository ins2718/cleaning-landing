const options = {
 ...
 Nos especializamos en la eliminación de polvo, suciedad, ácaros y bacterias de tus alfombras, utilizando técnicas avanzadas como la limpieza con vapor y agua caliente a 95 grados, garantizando una desinfección completa y un ambiente más saludable en tu hogar.
 Utilizamos productos y equipos de alta calidad para que tus alfombras queden como nuevas, libres de alérgenos y suciedad.
